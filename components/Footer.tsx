...
import { BookOpen, Twitter, Linkedin, Facebook, Instagram, Apple, Play, Send } from 'lucide-react';
        ...
        <div className="mb-12 md:mb-16 bg-brand-50 dark:bg-brand-900/10 rounded-2xl md:rounded-3xl p-6 md:p-10 flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-10 border border-brand-100 dark:border-brand-900/30">
          ...
          <div className="w-full max-w-md">
            <form className="flex flex-col sm:flex-row gap-2">
              ...
              <button 
                type="button"
                className="px-6 py-3 bg-brand-600 hover:bg-brand-700 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 shadow-lg shadow-brand-500/20"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-12 mb-8 md:mb-12">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-1.5 md:gap-2 mb-2 md:mb-4">
              ...
              <span className="text-base md:text-xl font-bold text-gray-900 dark:text-white">ElimuTech</span>
            </div>
            ...
            <div className="flex gap-3 md:gap-4 mb-4 md:mb-8">
              <a href="#" className="text-gray-400 hover:text-brand-600 dark:hover:text-brand-400 transition-colors"><Twitter size={14} className="md:w-5 md:h-5" /></a>
              <a href="#" className="text-gray-400 hover:text-brand-600 dark:hover:text-brand-400 transition-colors"><Linkedin size={14} className="md:w-5 md:h-5" /></a>
              <a href="#" className="text-gray-400 hover:text-brand-600 dark:hover:text-brand-400 transition-colors"><Facebook size={14} className="md:w-5 md:h-5" /></a>
              <a href="#" className="text-gray-400 hover:text-brand-600 dark:hover:text-brand-400 transition-colors"><Instagram size={14} className="md:w-5 md:h-5" /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 md:space-y-4 text-[10px] md:text-sm text-gray-500 dark:text-gray-400">
              <li><a href="#" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">Browse Courses</a></li>
              <li><a href="#" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">Mentorship</a></li>
              <li><a href="#" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">Pricing</a></li>
              <li><a href="#" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">For Business</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-1">
             ...
             <div className="flex flex-row md:flex-col gap-2 md:gap-3">
               <button className="flex-1 flex items-center gap-2 md:gap-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-3 py-1.5 md:px-4 md:py-2 rounded-lg md:rounded-xl hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors text-left">
